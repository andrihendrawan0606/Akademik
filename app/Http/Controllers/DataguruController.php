...
class dataguruController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('data.guru')->with(['success' => 'Data guru No '.$request->id.'Berhasil Di Tambah']);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('data.guru')->with(['success' => 'Data Guru No '.$request->id.'Berhasil Di Update']);
    }
    ...
    public function destroy($id, Request $request)
    {
        ...
        return redirect()->route('data.guru')->with(['success' => 'Data Guru No '.$request->id .'- Berhasil Di Hapus']);
    }
