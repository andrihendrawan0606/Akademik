    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item ">Edit Data Mata Pelajaran</span>
            </div>
        ...
        <div class="col-lg-11">
            <div class="input-group">
                <span class="input-group-prepend">
                    ...
                    <input type="text" name="kode_mapel" class="form-control @error('kode_mapel') is-invalid @enderror" value="{{$mapel->kode_mapel}}" placeholder="Masukkan Kode Mapel">
                @error('kode_mapel')
                    <span>
        ...
        <div class="col-lg-11">
            <div class="input-group">
                <span class="input-group-prepend">
                    ...
                    <input type="text" name="nama_mapel" class="form-control @error('nama') is-invalid @enderror" value="{{$mapel->nama_mapel}}" placeholder="Masukkan Nama Mapel">
                @error('nama_mapel')
                    <span>
                        <small class="text-danger">{{ $message }}</small>
                    </span>
        ...
        <div class="col-lg-11">
            <div class="input-group">
                <span class="input-group-prepend">
                    ...
                    <input type="text" name="guru" class="form-control @error('guru') is-invalid @enderror" value="{{$mapel->guru}}" placeholder="Masukkan Nama Guru">
                @error('Guru')
                    <span>
                        <small class="text-danger">{{ $message }}</small>
                    </span>
